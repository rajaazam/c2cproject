...
import 'package:c2c_bartering/Screen/Dashboard_Screens/Custom_price.dart';
import 'package:flutter/material.dart';


class Fixed_price extends StatefulWidget {
  const Fixed_price({Key? key, required String title}) : super(key: key);

  @override
  State<Fixed_price> createState() => _Fixed_priceState();
}

class _Fixed_priceState extends State<Fixed_price> {
  @override
