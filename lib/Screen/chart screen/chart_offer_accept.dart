...
class Chart_offer_Accept_Page extends StatefulWidget {
  const Chart_offer_Accept_Page({Key? key}) : super(key: key);

  @override
  State<Chart_offer_Accept_Page> createState() => _Chart_offer_Accept_PageState();
}

class _Chart_offer_Accept_PageState extends State<Chart_offer_Accept_Page> {
  @override
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                      ...
                      child:Row(
                        children: [
                          Text('Offer Accepted',style: TextStyle(color: Colors.green),),
                         SizedBox(width: 20,),
