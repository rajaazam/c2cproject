...
import 'package:c2c_bartering/Screen/chart%20screen/chart_accept_reject.dart';
...
class Chart_Offer_Made_Page extends StatefulWidget {
  const Chart_Offer_Made_Page({Key? key}) : super(key: key);

  @override
  State<Chart_Offer_Made_Page> createState() => _Chart_Offer_Made_PageState();
}

class _Chart_Offer_Made_PageState extends State<Chart_Offer_Made_Page> {
  @override
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        Navigator.push(context, (MaterialPageRoute(builder: (context)=>Chart_Accept_Reject_Page())));
                      },
                      icon: Icon(
                        Icons.more_vert,
                        size: 30,
