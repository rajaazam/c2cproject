...
class Items_Select_page extends StatefulWidget {
  const Items_Select_page({ Key? key }) : super(key: key);

  @override
  State<Items_Select_page> createState() => _Items_Select_pageState();
}

class _Items_Select_pageState extends State<Items_Select_page> {
  @override
          ...
          SizedBox(
              ...
              Row(
                ...
                IconButton(onPressed: (){
                  Navigator.push(context, (MaterialPageRoute(builder: (context)=>Items_Option_page())));
