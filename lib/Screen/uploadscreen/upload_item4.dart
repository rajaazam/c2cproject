...
class Upload_Item_Page4 extends StatefulWidget {
  const Upload_Item_Page4({Key? key}) : super(key: key);

  @override
  State<Upload_Item_Page4> createState() => _Upload_Item_Page4State();
}

class _Upload_Item_Page4State extends State<Upload_Item_Page4> {
  @override
                ...
                child: Container(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                        ...
                        hintText: 'Enter brand name',contentPadding: EdgeInsets.only(left: 10),
                ...
                child: Container
                    ...
                    (
                      ...
                      child: TextButton(onPressed: (){
                        Navigator.push(context, (MaterialPageRoute(builder: (context)=>Upload_Item_violation_Page5())));
                      }, 
