...
import 'package:c2c_bartering/Screen/uploadscreen/Expanle.dart';
...
class Upload_Item_Page2 extends StatefulWidget {
  const Upload_Item_Page2({Key? key}) : super(key: key);

  @override
  State<Upload_Item_Page2> createState() => _Upload_Item_Page2State();
}

class _Upload_Item_Page2State extends State<Upload_Item_Page2> {

  String dropdownvalue = 'Tops';
  var items = [
    'Tops',
    'One-piece',
    'Skirts',
                 ...
                 Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton(
                     // menuMaxHeight: double.tryParse('150.14'),
        ...
        child: TextButton(
            ...
            child: Text(
              ...
              Row(
                ...
                children: [
                  Text('Retail Price (\$)',style:TextStyle(fontSize: 20, color: Colors.black) ,),
                  Container(
                  height: 40,
                  width: 140,
                  padding: EdgeInsets.only(left: 10,top: 10),
                ...
                child: Container
                    ...
                    (
                      ...
                      child: TextButton(onPressed: (){
                         Navigator.push(context, (MaterialPageRoute(builder: (context)=>Upload_Item_Page3())));
                      }, 
