...
class Upload_Item_Page0 extends StatefulWidget {
  const Upload_Item_Page0({Key? key}) : super(key: key);

  @override
  State<Upload_Item_Page0> createState() => _Upload_Item_Page0State();
}

class _Upload_Item_Page0State extends State<Upload_Item_Page0> {
  @override
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    ...
                    hintText:
                        'Explain whether the item is too tight, too loose etc .'),
              ),
            ),
            SizedBox(
              height: 20,
                  ...
                  child: TextButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            (MaterialPageRoute(
                                builder: (context) => Upload_Item_Page1())));
                      },
                      child: Center(
                          child: Text(
                        'Upload Item',
